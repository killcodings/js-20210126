...
import SortableList from '../../../09-tests-routes-browser-history-api/2-sortable-list/src/index.js';

const IMGUR_CLIENT_ID = 'cf2da29e18ff4bf9bbcc085c4281fede';
    ...
    uploadImage = () => {
        ...
        fileInput.onchange = async () => {
            ...
            if (file) {
                ...
                const result = await fetchJson(`https://api.imgbb.com/1/upload?key=${IMGUR_CLIENT_ID}`, {
                    method: 'POST',
                    // headers: {
                ...
                imageListContainer.append(this.getImageItem(result.data.url, file.name));
